...
/** @category NSBezierPath(CPTPlatformSpecificNSBezierPathExtensions)
 *  @brief NSBezierPath extensions for drawing styled text.
 **/
@implementation NSBezierPath(CPTPlatformSpecificNSBezierPathExtensions)
...
+ (nonnull NSBezierPath*)bezierPathWithCGPath:(CGPathRef _Nonnull)cgPath {
