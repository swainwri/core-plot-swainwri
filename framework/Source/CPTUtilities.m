...
// added S.Wainwright 5/03/2021
#pragma mark -
#pragma mark Easy On the Eye Scaling

BOOL CPTEasyOnTheEyeScaling(double FMin, double FMax, int N, double *ValueMin, double *ValueMax, double *Step) {
    BOOL iFault = NO;
    // C
    ...
    double UNIT[10] = { 1.0, 1.5, 2.0, 2.5, 3.0, 4.0, 5.0, 6.0, 8.0, 10.0 };
    //     Local variables
    
    int i, j;
    double TOL = 5.0E-6, BIAS = 1.0E-4;
