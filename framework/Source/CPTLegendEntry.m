...
#import "CPTLineStyle.h" //  S.Wainwright 21/03/21
...
/** @property nullable CPTPlot *plotCustomised
 *  @brief The plot associated with this legend entry for a customised legend.
 **/
@synthesize plotCustomised;
...
/** @property NSUInteger indexCustomised
 *  @brief The zero-based customised index of the legend entry for the given plot.
 **/
@synthesize indexCustomised;
...
// S.Wainwright 19/03/21
/** @property nullable NSString *titleCustomised
 *  @brief The customised legend entry title.
 **/
@synthesize titleCustomised;

/** @property nullable NSAttributedString *attributedTitleCustomised
 *  @brief The customised legend entry attributed title.
 **/
@synthesize attributedTitleCustomised;
...
/** @property nullable CPTLineStyle *lineStyleCustomised
 *  @brief The customised line style used to draw the legend entry swatch.
 **/
@synthesize lineStyleCustomised;
...
-(nonnull instancetype)init
{
    if ((self = [super init])) {
        ...
        plotCustomised = nil;
        index     = 0;
        indexCustomised = NSNotFound;
        row       = 0;
        column    = 0;
        textStyle = nil;
        titleCustomised = nil;  //  S.Wainwright 19/03/21
        attributedTitleCustomised =  nil;
        lineStyleCustomised = nil;
    }
    return self;
}
...
-(nullable NSString *)title
{
    ...
    if ( thePlot ) {  // added SWainwright 19/03/21

        return [thePlot titleForLegendEntryAtIndex:self.index];
    }
    else {
        return self.titleCustomised;
    }
}
...
-(nullable NSAttributedString *)attributedTitle
{
    ...
    if ( thePlot ) {  // added SWainwright 19/03/21
        ...
        return self.attributedTitleCustomised;
    }
}
