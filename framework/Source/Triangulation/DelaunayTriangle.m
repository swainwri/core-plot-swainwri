...
@property (nonatomic, strong) NSArray *pointsCache;
...
- (CGPoint)circumcenter {
    ...
    CGFloat m1 = (p2.y - p1.y) / (p2.x - p1.x);
    CGFloat perpendicularM1 = -1 / m1;
    CGFloat c1 = -perpendicularM1 * midpoint1.x + midpoint1.y;
    
    CGPoint midpoint2 = CGPointMake((p2.x + p3.x) / 2.0, (p2.y + p3.y) / 2.0);
    CGFloat m2 = (p3.y - p2.y) / (p3.x - p2.x);
    CGFloat perpendicularM2 = -1 / m2;
    CGFloat c2 = -perpendicularM2 * midpoint2.x + midpoint2.y;
    
    CGPoint midpoint3 = CGPointMake((p3.x + p1.x) / 2.0, (p3.y + p1.y) / 2.0);
    CGFloat m3 = (p1.y - p3.y) / (p1.x - p3.x);
    CGFloat perpendicularM3 = -1 / m3;
    CGFloat c3 = -perpendicularM3 * midpoint3.x + midpoint3.y;
    ...
    CGFloat circumcenterX = (c2 - c1) / (perpendicularM1 - perpendicularM2);
    CGFloat circumcenterY = perpendicularM1 * circumcenterX + c1;
