...
@objc protocol ContourManagerComboBoxDelegate: NSObjectProtocol{
    @objc optional func contourManagerComboBoxChoice(_ contourManagerViewController: ContourManagerComboBox, userSelectedChoiceChanged changed: Bool, contourManagerCounter: Int)
}

class ContourManagerComboBox: NSComboBox, NSComboBoxDelegate, NSComboBoxDataSource, NSComboBoxCellDataSource {
    
    weak var delegate: ContourManagerComboBoxDelegate?
